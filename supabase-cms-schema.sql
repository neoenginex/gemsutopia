...
('about', 'About Gemsutopia', 'Welcome to Gemsutopia - your premier destination for rare and beautiful gemstones...', 'Learn about Gemsutopia''s mission to bring you the finest gemstones and jewelry from around the world.'),
('support', 'Customer Support', 'We''re here to help with any questions about our products or services...', 'Get help with your Gemsutopia orders, returns, and product questions.'),
...
('Do you offer custom jewelry services?', 'Yes, we provide custom jewelry design services. Contact us to discuss your vision and we''ll create a unique piece just for you.', 'services', 2),
